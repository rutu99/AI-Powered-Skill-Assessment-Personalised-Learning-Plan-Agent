...
def _generate_with_reportlab(report: dict, output_path: str):
    ...
    story.append(Paragraph(
        f"Generated by SkillSense AI | {datetime.now().strftime('%Y-%m-%d %H:%M')} | "
...
def _generate_with_fpdf(report: dict, output_path: str):
    ...
    pdf.cell(0, 12, "SkillSense AI — Assessment Report", ln=True, align="C")
...
def _report_to_text(report: dict) -> str:
    lines = [
        "SKILLSENSE AI — ASSESSMENT REPORT",
        "=" * 50,
